...
def test_mcp_session_affinity_apply_and_check_use_context(sdk_client: ObligationRuntimeClient) -> None:
    ...
    apply_out = tools["obligation/apply_patch"](session_id=None, files={"Mini/Basic.lean": "def x := 1\n"})
...
def test_mcp_get_review_payload_and_submit_decision(sdk_client: ObligationRuntimeClient, gateway_app) -> None:
    ...
    deps.review_store.put("mcp-thread-1", {"thread_id": "mcp-thread-1", "status": "awaiting_review"})
